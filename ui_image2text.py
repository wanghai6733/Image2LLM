...
class Ui_image2textWidget(object):
    def setupUi(self, image2textWidget):
        ...
        self.pushButtonSearch = QtWidgets.QPushButton(image2textWidget)
        self.pushButtonSearch.setMinimumSize(QtCore.QSize(31, 31))
        self.pushButtonSearch.setMaximumSize(QtCore.QSize(31, 31))
    ...
    def retranslateUi(self, image2textWidget):
        ...
        self.pushButtonSearch.setText(_translate("image2textWidget", "search"))
